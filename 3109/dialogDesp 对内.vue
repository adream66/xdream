  ...
  >
    <q-card class="bg-white text-black">
      <q-card-section class="no-padding">
        ...
        <a-tooltip trigger="hover">
          ...
          {{specialBettingLimit_title[detailObj.specialBettingLimitType]}} 
              <a-input v-model="percentageLimit" v-if="detailObj.specialBettingLimitType==2" style="width:55px;margin-top:7px"  readonly disabled  class="disabled-white"/></div>
      ...
      <div class="row mt20x mb20x">
          ...
          <div class="append-handle-btn-input col-10">
