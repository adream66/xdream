 ...
 * @FilePath: /src/components/common/bettinguser/external/component/dialogDesp.vue
 -->
<template>
  <div style="width: 530px ; height:auto;max-width:700px;overflow:hidden;" class="text-panda-text-7">
    <q-card class="bg-white text-black">
      <q-card-section class="no-padding">
        <div class="row line-height-40px fs14 bg-panda-dialog text-panda-text-7 pr10x">
          ...
          <div class="pl20x fw_600 col q-pr-md" v-if="!can_edit && [1].includes(detailObj.specialBettingLimitType)">
          ...
          <div class="pl20x fw_600 col q-pr-md" v-if="!can_edit && is_specialBettingLimitType_2">
            <a-tooltip trigger="hover">
              <!-- 对特殊VIP限额、特殊单注单场限额、单注限额百分比的用户限额需求，需联系B端风控 -->
          ...
          <div v-if="can_edit && [1].includes(detailObj.specialBettingLimitType)
            ">

            <!-- 编辑情况下      //   "1": "无"  -->
            <div class="pl20x fw_600 col q-pr-md">
              ...
              <a-select v-model="percentageLimit" style="width:105px;margin-top:7px" class="disabled-white"
      ...
      <div class=" pt10x pl20x pr20x pb20x fixed-footer">
        ...
        <div style="font-size: 14px;" v-if="
          ...
          can_edit &&  is_specialBettingLimitType_2
          ">
            <dialogSpecialBetLimit :disabled="false" :detailObj="detailObj"></dialogSpecialBetLimit>
        </div>
