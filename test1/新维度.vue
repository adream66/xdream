...
<template>
  <div class="quota-inquiry">
    ...
    <div class="pl10x q-py-md">
      <!-- 单关可用额度查询 -->
      <div style="padding: 10px 0; background: #ccc; font-weight:bold ; ">
      ...
      <div class="series-div">
        ...
        <div class="x-singer">
          <div>
            <span style="color:rgb(246, 154, 35)">{{ $t("internal.user_betting_amount.label19") }}</span>

          </div>
          <div class="x-singer-right">
            <span style="color:rgb(246, 154, 35)">{{ $t("internal.user_betting_amount.label20") }}</span>
